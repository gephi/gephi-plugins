...
public class DynamicAveragePathLengthUI implements StatisticsUI {

    private final StatSettings settings = new StatSettings();
    private DynamicAveragePathLength degree;
    private DynamicAveragePathLengthPanel panel;

    public JPanel getSettingsPanel() {
        panel = new DynamicAveragePathLengthPanel();
        return panel;
    }

    public void setup(Statistics statistics) {
        this.degree = (DynamicAveragePathLength) statistics;
        if (panel != null) {
    ...
    private static class StatSettings {
        ...
        private void save(DynamicAveragePathLength stat) {
            
            this.window = stat.getWindow();
            this.tick = stat.getTick();
        }

        private void load(DynamicAveragePathLength stat) {
