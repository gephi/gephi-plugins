 ...
 */
public class DynamicEntropyPanel extends javax.swing.JPanel {

    /** Creates new form DynamicDegreePanel */
    public DynamicEntropyPanel() {
        initComponents();
    ...
    private void initComponents() {
        ...
        header.setDescription("[Experimental] Statistic that calculates the additions and subtractions of a window per every tick. "); // NOI18N
        header.setTitle("Window Distance"); // NOI18N
