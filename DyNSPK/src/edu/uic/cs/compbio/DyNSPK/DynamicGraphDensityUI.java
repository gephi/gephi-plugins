...
public class DynamicGraphDensityUI implements StatisticsUI {

    private final StatSettings settings = new StatSettings();
    private DynamicGraphDensity degree;
    private DynamicGraphDensityPanel panel;

    public JPanel getSettingsPanel() {
        panel = new DynamicGraphDensityPanel();
        return panel;
    }

    public void setup(Statistics statistics) {
        this.degree = (DynamicGraphDensity) statistics;
        if (panel != null) {
    ...
    private static class StatSettings {
        ...
        private void save(DynamicGraphDensity stat) {
            
            this.window = stat.getWindow();
            this.tick = stat.getTick();
        }

        private void load(DynamicGraphDensity stat) {
