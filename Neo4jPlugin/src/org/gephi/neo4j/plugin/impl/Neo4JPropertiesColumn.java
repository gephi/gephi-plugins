...
/**
 * Enum that define static <code>AttributeColumn</code> indexes, like <code>NEO4J_RELATIONSHI_TYPE</code>
 * or <code>NEO4J_NODE_TYPE</code>. Use these enum to find the index of these columns in
 * node and edge table.
 ...
 */
public enum Neo4JPropertiesColumn {
    ...
    // TODO: not sure, if NEO4J-Columns should go in org.gephi.data.*?
    NEO4J_NODE_LABEL(2, "neo4j_nl", AttributeType.LIST_STRING, AttributeOrigin.DELEGATE, null) {

        @Override
        public String getTitle() {
            return "Neo4j Node Labels";
        }
    };
    ...
    Neo4JPropertiesColumn(int index, String id, AttributeType attributeType, AttributeOrigin origin, Object defaultValue) {
        this.index = index;
        this.id = id;
