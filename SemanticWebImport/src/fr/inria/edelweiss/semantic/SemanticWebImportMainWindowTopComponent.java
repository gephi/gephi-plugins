...
public final class SemanticWebImportMainWindowTopComponent extends TopComponent implements SparqlRequester, LongTaskListener {
    ...
    private void initComponents() {
        ...
        fynSpinner.setModel(new javax.swing.SpinnerNumberModel(Integer.valueOf(0), Integer.valueOf(0), null, Integer.valueOf(1)));
    ...
    /**
     * Set the values of the properties by reading the GUI state elements. \todo
     * Should be in the configuration manager, with a listener mechanism to
    ...
    /**
     * Apply a SPARQL request on the RDF used to display the graph. For example,
     * a "select ?x ?y ?z where { ?x ?y ?z} limit 10" query will return a
     * String[3][] array of size at most 10. The first column will contain the
     * results for ?x, the second for ?y, etc.
     *
     * @param request
    ...
    class LogWindowHandler extends Handler {
        ...
        public void publish(LogRecord record) {
            logWindow.append(getFormatter().format(record) + '\n');
    ...
    /**
     * Obtain the SemanticWebImportMainWindowTopComponent instance. Never call
