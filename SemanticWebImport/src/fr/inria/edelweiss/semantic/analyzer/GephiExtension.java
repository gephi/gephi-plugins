    ...
    public static void processGephiExtension(final String sourceLabel, final String edgeLabel, final String targetLabel, final GephiUtils gephiUtil) {
        ...
        if (edgeLabel.equals(GEPHI_SET_SHAPE)) {
            ...
            if (gephiUtil.isEdge(sourceLabel)) {
                ...
                Attributes attributes = gephiUtil.getEdgeAttributes(sourceLabel);
                attributes.setValue(nameNewAttribute, targetLabel);
            } else {
                gephiUtil.addAttributeToNodes(nameNewAttribute);
                Attributes attributes = gephiUtil.getNodeAttributes(sourceLabel);
                attributes.setValue(nameNewAttribute, targetLabel);
            }
        }
    }
