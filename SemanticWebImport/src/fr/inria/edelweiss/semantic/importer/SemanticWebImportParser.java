...
/**
 * Responsible for making the request and building the resulting graph asynchronously. The purpose of this class is to: <ol> <li>use a SPARQL driver to obtain a
 * RDF/XML result;</li> <li>populate the graph by extracting in the result the nodes and the edges.</li> </ol>
 *
