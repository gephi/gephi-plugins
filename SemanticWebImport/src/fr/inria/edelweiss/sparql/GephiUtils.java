...
public class GephiUtils {
    ...
    public void addNode(String id) {
        if (!nodeExist(id)) {
            ...
            int idNum = (Integer)(newNode.getId());
    ...
    public void addAttributeToNodes(final String columnName) {
        AttributeController ac = Lookup.getDefault().lookup(AttributeController.class);
        AttributeModel attributesModel = ac.getModel();

        if (!attributesModel.getNodeTable().hasColumn(columnName)) {
            attributesModel.getNodeTable().addColumn(columnName, AttributeType.STRING);
        }
    }
    ...
    public void addAttributeToEdges(String columnName) {
        AttributeController ac = Lookup.getDefault().lookup(AttributeController.class);
        AttributeModel attributesModel = ac.getModel();

        if (!attributesModel.getEdgeTable().hasColumn(columnName)) {
            attributesModel.getEdgeTable().addColumn(columnName, AttributeType.STRING);
        }
