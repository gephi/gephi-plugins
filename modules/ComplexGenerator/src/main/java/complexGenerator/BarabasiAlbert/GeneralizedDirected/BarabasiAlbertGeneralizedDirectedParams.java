...
public class BarabasiAlbertGeneralizedDirectedParams extends Params<BarabasiAlbertGeneralizedDirected> {
    public Integer N = 50;
    public Integer M = 1;
    public Integer m0 = 1;
    ...
    @Override
    public void SetGeneratorParams(BarabasiAlbertGeneralizedDirected barabasiAlbert) {
