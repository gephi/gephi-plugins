...
public class BarabasiAlbertSimplifiedADirected implements Generator {
    ...
    public String getName() {
        return "Barabasi-Albert Scale Free model A [Directed]";
    }

    @Override
    public GeneratorUI getUI() {
        return Lookup.getDefault().lookup(IBarabasiAlbertSimplifiedADirectedUI.class);
    }
