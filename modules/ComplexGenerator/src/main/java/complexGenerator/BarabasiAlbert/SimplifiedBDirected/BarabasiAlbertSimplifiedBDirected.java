...
public class BarabasiAlbertSimplifiedBDirected implements Generator {
    ...
    public String getName() {
        return "Barabasi-Albert Scale Free model B [Directed]";
    }

    @Override
    public GeneratorUI getUI() {
        return Lookup.getDefault().lookup(IBarabasiAlbertSimplifiedBDirectedUI.class);
    }
