...
public class Panel3Wizard implements WizardDescriptor.Panel<WizardDescriptor>, PropertyChangeListener {
    ...
    public void readSettings(WizardDescriptor data) {
        ...
        if (MyFileImporter.getFirstConnectedAgent().equals(MyFileImporter.getSecondConnectedAgent())) {
            ...
            ((Panel3) getComponent()).jLabelSecondConnectedAgent.setVisible(true);
            ((Panel3) getComponent()).jLabelSecondAgentAlso.setVisible(true);
            ((Panel3) getComponent()).getjListDelimiterSecondAgent().setVisible(true);
            ((Panel3) getComponent()).jScrollPane2.setVisible(true);
        }
    }
