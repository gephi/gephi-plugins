package net.clementlevallois.excelcsvimporter.controller;
...
import net.clementlevallois.excelcsvimporter.parsers.CsvParser;
import net.clementlevallois.excelcsvimporter.parsers.ExcelParser;
import net.clementlevallois.excelcsvimporter.wizard.Panel1;
import net.clementlevallois.excelcsvimporter.wizard.Panel2;
import net.clementlevallois.excelcsvimporter.wizard.Panel4;
...
/**
 * File importer example which can import the Matrix Market file format. This format is a text-based representation of a matrix and can be tested with
 * <a
 * href="http://www2.research.att.com/~yifanhu/GALLERY/GRAPHS/index.html">Yifan Hu's matrix gallery</a>.
 * <p>
 * The example show how graph data should be set in the {@link ContainerLoader} instance. It shows how {@link NodeDraft} and {@link EdgeDraft} are created from the factory. It also append logs in the
 * {@link Report} class, which is the standard way to report messages and issues.
 *
