...
public class Panel1Wizard implements WizardDescriptor.ValidatingPanel {
    ...
    public void validate() throws WizardValidationException {
        if (Panel1.fileSelectedName == null) {
            throw new WizardValidationException(null, "Please select a csv  file", null);
        }
        else if (Panel1.fileSelectedName.endsWith("xls")||Panel1.fileSelectedName.endsWith("xlsx")) {
            throw new WizardValidationException(null, "Only csv / text file accepted", null);
        }
