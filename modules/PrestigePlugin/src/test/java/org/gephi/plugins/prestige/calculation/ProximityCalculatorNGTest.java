 ...
 */
public class ProximityCalculatorNGTest extends AbstractCalculatorNGTest {

    private final ProximityCalculator calc = new ProximityCalculator();
    ...
    public void circleGraph_FiveNodes_AllSamePrestige() {
        super.circleGraph_FiveNodes_AllSamePrestige(calc, 0.4D, -1);
    }
    ...
    protected String getPrestigeColumnKey() {
        return ProximityCalculator.PROXIMITY_KEY;
    }
