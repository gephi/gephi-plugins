...
public class RandomPRemovalStrategyBuilder implements FilterBuilder {
    ...
    public String getName() {
        return "Random - Probability version";
    }
    ...
    public Filter getFilter(Workspace workspace) {
        return new RandomPRemovalStrategy();
    }

    @Override
    public JPanel getPanel(Filter filter) {
        RandomPRemovalStrategyParams panel = new RandomPRemovalStrategyParams(filter);
        return panel;
    }
