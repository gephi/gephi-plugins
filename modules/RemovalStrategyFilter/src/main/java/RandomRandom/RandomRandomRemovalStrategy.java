 ...
 */
public class RandomRandomRemovalStrategy implements ComplexFilter {
    ...
    public String getName() {
        return "Remove random neighbour of random node (repeat N tunes)";
    }
    ...
    public Graph filter(Graph graph) {
        ...
        for(int i =0; i< N; i++){
            ...
            graph.removeNode(neighbours[index]);
        }
        return graph;
    }
}