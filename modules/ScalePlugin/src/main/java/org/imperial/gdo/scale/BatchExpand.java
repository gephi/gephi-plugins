...
public class BatchExpand implements LayoutBuilder {

    private ExpandLayoutUI ui = new ExpandLayoutUI();

    @Override
    public String getName() {
        return NbBundle.getMessage(Expand.class, "batchexpand.name");
    }
    ...
    private static class ExpandLayoutUI implements LayoutUI {
        ...
        public String getDescription() {
            return NbBundle.getMessage(Expand.class, "batchexpand.description");
        }
