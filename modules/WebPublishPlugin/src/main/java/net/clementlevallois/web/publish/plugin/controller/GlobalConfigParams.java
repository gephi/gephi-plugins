...
public class GlobalConfigParams {
    ...
    public static final String ERROR_CODE_NO_OPEN_PROJECT = "95";
    public static final String ERROR_CODE_EMPTY_NETWORK = "96";
    public static final String ERROR_CODE_GEXF_TOO_BIG = "97";
    public static final String SUCCESS_BUT_WITH_WARNING = "209";
