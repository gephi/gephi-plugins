 ...
 */
public class WeightedBridgingCentralityMetric extends GraphDistance {

    private static final Logger LOG = Logger.getLogger(WeightedBridgingCentralityMetric.class.getName());

    public static final String BETWEENNESS_CENTRALITY = "weightedbetweennesscentrality";
    public static final String BRIDGING_CENTRALITY = "weightedbridgingcentrality";
    ...
    public void execute(GraphModel graphModel) {
        ...
        execute(graph);
        LOG.log(java.util.logging.Level.INFO, "Success Weighted Bridging Centrality calculations.");
    }
    ...
    public void execute(Graph graph) {
        ...
        try {
            ...
            // -----------
            if (cancelled) {
                String msg = NbBundle.getMessage(WeightedBridgingCentralityMetric.class, "WeightedBridgingCentralityMetric.alert.message");
                String title = NbBundle.getMessage(WeightedBridgingCentralityMetric.class, "WeightedBridgingCentralityMetric.alert.title");
                ...
                String duration = NbBundle.getMessage(WeightedBridgingCentralityMetric.class, "WeightedBridgingCentralityMetric.report.duration");
    ...
    private void initializeAttributeColunms(GraphModel graphModel) {
        ...
        if (!nodeTable.hasColumn(BETWEENNESS_CENTRALITY)) {
            nodeTable.addColumn(BETWEENNESS_CENTRALITY, "Weighted Betweenness Centrality", BigDecimal.class, new BigDecimal("0"));
        }
        ...
        if (!nodeTable.hasColumn(BRIDGING_CENTRALITY)) {
            nodeTable.addColumn(BRIDGING_CENTRALITY, "Weighted Bridging Centrality", BigDecimal.class, new BigDecimal("0"));
        }
    }
    ...
    private double[] calculateBetweeness(Graph graph, HashMap<Node, Integer> indicies, boolean directed, boolean normalized) {
        ...
        //Weighted shortest-path search to calculate all shortest paths from node s to t
        for (Node s : graph.getNodes()) {
            ...
            double[] dist = new double[Number_of_Nodes];
...
while (!Q.isEmpty()) {
    ...
    for (Edge edge : edgeIter) {
        ...
        // Found another shortest path of equal length.
            ...
            //Now it is possible to calculate betweenness by popping the stack created during the weighted shortest-path search
    ...
    private void BFS_Initialization(LinkedList<Node>[] Pred, double[] sigma, double[] dist, int index, int n) {
        ...
        for (int w = 0; w < n; w++) {
            ...
            dist[w] = Double.POSITIVE_INFINITY;
    ...
    public String getReport() {
        ...
        try {
            ...
            htmlIMG1 = createImageFile(tempDir, bridging_cent, "Weighted Bridging Centrality Distribution", "Value", "Count");
            //            htmlIMG2 = createImageFile(tempDir, bridging_coef, "Bridging Coefficient Distribution", "Value", "Count");
            htmlIMG3 = createImageFile(tempDir, mybetweenness, "Weighted Betweenness Centrality Distribution", "Value", "Count");
        } catch (IOException ex) {

            String msg = NbBundle.getMessage(WeightedBridgingCentralityMetric.class, "WeightedBridgingCentralityMetric.error.message");
            String title = NbBundle.getMessage(WeightedBridgingCentralityMetric.class, "WeightedBridgingCentralityMetric.error.title");
            JOptionPane.showMessageDialog(null, msg, title, JOptionPane.ERROR_MESSAGE);

            LOG.log(java.util.logging.Level.SEVERE, msg, ex);
        }

        String report_title = NbBundle.getMessage(WeightedBridgingCentralityMetric.class, "WeightedBridgingCentralityMetric.report.title");
        String params = NbBundle.getMessage(WeightedBridgingCentralityMetric.class, "WeightedBridgingCentralityMetric.report.params");
        String param_1 = NbBundle.getMessage(WeightedBridgingCentralityMetric.class, "WeightedBridgingCentralityMetric.report.params.par_1");
        String value_1_1 = NbBundle.getMessage(WeightedBridgingCentralityMetric.class, "WeightedBridgingCentralityMetric.report.params.par_1.value_1");
        String value_1_2 = NbBundle.getMessage(WeightedBridgingCentralityMetric.class, "WeightedBridgingCentralityMetric.report.params.par_1.value_2");
        String value_2_1 = NbBundle.getMessage(WeightedBridgingCentralityMetric.class, "WeightedBridgingCentralityMetric.report.params.par_2.value_1");
        String value_2_2 = NbBundle.getMessage(WeightedBridgingCentralityMetric.class, "WeightedBridgingCentralityMetric.report.params.par_2.value_2");
        String results = NbBundle.getMessage(WeightedBridgingCentralityMetric.class, "WeightedBridgingCentralityMetric.report.results");

        String param_2 = NbBundle.getMessage(WeightedBridgingCentralityMetric.class, "WeightedBridgingCentralityMetric.report.params.par_2");
        ...
        String algorithms = NbBundle.getMessage(WeightedBridgingCentralityMetric.class, "WeightedBridgingCentralityMetric.report.algorithm");
        String credits = NbBundle.getMessage(WeightedBridgingCentralityMetric.class, "WeightedBridgingCentralityMetric.report.credits");

        rep += "<br /><br />"
                + "<br>Please, check the Data Laboratory Tab for the full listing of Weighted Bridging Centrality for the graph.</br>"
                + "<br /><br />"
                + htmlIMG1 + "<br /><br />"
                + htmlIMG2 + "<br /><br />"
                + htmlIMG3 + "<br /><br />"
                ...
                + "<li>E. W. Dijkstra, <b>A Note on Two Problems in Connexion with Graphs</b>, in Numerische Mathematik 1:269-271, (1959)</li>"
                ...
                + "<b>" + credits + ": </b>"
                + "<ul>"
                + "<li>Original Bridging Centrality plugin implementation: Get&uacute;lio de Morais Pereira, Anderson Rodrigues dos Santos, and Luis Felipe Nunes Reis</li>"
                + "<li>Weighted Bridging Centrality adaptation: Nathan Steinmeyer</li>"
                + "<ul>"
                + "</BODY> </HTML>";
